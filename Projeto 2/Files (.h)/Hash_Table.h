...
//   // Inserting
//   printf("\nParking...\n");
//   insert_Data(table, "1", "0001", 50, 1);
//   insert_Data(table, "2", "0002", 30, 2);
//   insert_Data(table, "3", "0003", 40, 3);
//   insert_Data(table, "4", "0004", 32, 4);
//   insert_Data(table, "Hel", "0005", 64, 5);
//   insert_Data(table, "Cau", "0006", 20, 8); // Chain
//   insert_Data(table, "Hdm", "0007", 100, 10); // Chain
